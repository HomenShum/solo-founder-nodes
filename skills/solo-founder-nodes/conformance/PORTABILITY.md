...
|---|---|---|
| **Substrate is identical everywhere** | `templates/` is plain Node/Python; `npm i && npm run smoke` currently reports **160 passed, 0 failed** with zero agent involvement | proven (reproducible by anyone) |
...
| **Codex (OpenAI)** | A/B - Codex Skills / `AGENTS.md`, else C | local probe PASS, receipt `eaf19c48c0b52960`, current substrate smoke 160/160 |
